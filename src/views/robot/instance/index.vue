  ...
  <div class="app-container">
    ...
    <el-dialog append-to-body :close-on-click-modal="false" :before-close="crud.cancelCU" :visible.sync="crud.status.cu > 0" :title="crud.status.title" width="520px">
      <el-form ref="form" :inline="true" :model="form" :rules="rules" size="small" label-width="80px">
        ...
        <el-form-item label="推送地址" prop="address">
          <el-input v-model="form.address" style="width: 380px;" />
        </el-form-item>
        <el-form-item label="实例级别" prop="level">
          <el-input-number v-model.number="form.level" :min="1" :max="5" controls-position="right" style="width: 145px;" />
        </el-form-item>
...
export default {
  ...
  cruds() {
    return CRUD({ title: '实例', url: 'api/roles', sort: 'level,asc', crudMethod: { ...crudRoles }})
  },
  ...
  data() {
    return {
      ...
      rules: {
        ...
        address: [
          { required: true, message: '请输入群机器人webhook地址', trigger: 'blur' }
        ],
        level: [
